...
# I had to create a dictionary witch usersamples 
# Else it would't have worked on your pc

user_data = {"jimmy": "h3l!0", "charles": "wh4!", "zoe": "n0o!"}  # This is the dictionary with the usersamples

with open('userdata.txt', 'w') as outfile:  # I created a file named userdata.txt which contains the dictionary
    json.dump(user_data, outfile)

with open("userdata.txt", "r") as file1:  # I loaded the file and cleared the dictionary, so it's epmty
    user_data = json.load(file1)
    user_data.clear()

# If you ran the program once on you pc, you can delete  everything between line 4 - 16


# Just clear the # before the code below for the program to work!!!
                    ...
                    if login_input2 == str(user_data[login_input]):
                        ...
                        while True:
                            ...
                            if trys == 1:
                                ...
                                print("Try again!")
                                print("")
                                print("If you fail one more time, you are not allowed to log in anymore")
                                break
        ...
        if admin_password == "kriegst du nie!":
            ...
            while True:
                ...
                if user_input2 == "user data":
                    ...
                    if account_delete in user_data:
                        del user_data[account_delete]

                    else:
                        print("This account is not existing or the input is unknown")

                    print("")
                    print("The account has been removed succesfully")
                    break
