...
# login section
def login():
    global login_input # I have to use that variable multiple times -> I'm making it global 
...
def delete():
    ...
    if user_input == "quit":
        ...
        with open('userdata.json', 'w') as outfile:
            json.dump(user_data, outfile) # saving the new userdata without the deleted user's data
